...
from django.contrib.auth.models import BaseUserManager, PermissionsMixin, AbstractUser, Group, Permission
...
class CustomUser(AbstractUser, PermissionsMixin):
    ...
    user_permissions = models.ManyToManyField(
        ...
        related_name="customuser_permissions_set",  # Add this line
        related_query_name="user",
    )
